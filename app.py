...
# ------------ PYTHON QUESTIONS PART 2 ------------
    ...
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=2, question=u'2️⃣ What is the output of print (10 * 2)?', answer=u'20'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=3, question=u'3️⃣ Given a variable python = "Snake", How do you output "Snake"?', answer=u'print(python)'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=4, question=u'4️⃣ What is the syntax to create a class named person ?', answer=u'class Person:'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=5, question=u'5️⃣ How would you display the integer 42 as a string?', answer=u'print("42")'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=6, question=u'6️⃣ Given an list l = [15, "Bike", True]. What would be the output of print(l[0]) output?', answer=u'15'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=7, question=u'7️⃣ Given an list l = ["Cat", 2, "dog"]. If you do l.append(4), what would be the output of print(l[3]) ?', answer=u'4'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=8, question=u'8️⃣ Given a dictionnary d = {"marvel":  "Iron Man", "Dc Comics": "Batman"}. What would be the output of print(d.get("marvel"))', answer=u'Iron Man'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=9, question=u'9️⃣ Given a string s = "Hello everyone!". How would you output the lenght of it?', answer=u'print(len(s))'))
    db.session.add(QuestionLevel2(language=u'Ruby', question_display_id=10, question=u'🔟 Given a string s = "amazing". What would be the output of print(s.upper())?', answer=u'AMAZING'))
